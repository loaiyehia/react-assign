...
export default function Contact() {
  return (
    <div>
<form className="w-1/2 mx-auto py-24">
  ...
  <button className="text-white bg-[#1ABC9C] hover:bg-[#246c5e] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Send Message</button>
</form>
</div>
